...
description: Refine an existing Linear issue with full context, clarifying questions, and a polished description. Use when the user wants to flesh out, refine, or add detail to an existing issue.
user_invocable: true
---
